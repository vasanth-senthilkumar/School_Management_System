...
export const listStudents = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get('https://hidden-oasis-02186.herokuapp.com/api/students')
    dispatch({
...
export const classlistStudent = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://hidden-oasis-02186.herokuapp.com/api/students/class/${id}`)
    dispatch({
...
export const studentSearch = (name, classname, rollno) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://hidden-oasis-02186.herokuapp.com/api/students/search/${name}/${classname}/${rollno}`
    )
...
export const Register = (
  ...
  try {
    ...
    const { data } = await axios.post(
      'https://hidden-oasis-02186.herokuapp.com/api/students/register',
      {
        student_name,
        classname,
...
export const deleteStudent = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`https://hidden-oasis-02186.herokuapp.com/api/students/delete/${id}`)
    dispatch({
...
export const studentAttendances = (classname, students) => async (
  ...
  try {
    ...
    const { data } = await axios.post(
      `https://hidden-oasis-02186.herokuapp.com/api/students/attendance/${classname}`,
      {
        students,
      },
      config
...
export const PayFees = (
  ...
  try {
    ...
    const { data } = await axios.post(
      `https://hidden-oasis-02186.herokuapp.com/api/students/fees/${studentId}`,
      {
        student_name,
        classname,
        roll_no,
